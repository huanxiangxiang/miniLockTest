...
public final class ViewfinderView extends View {
  ...
  private void drawCorner(Canvas canvas, Rect frame) {
    ...
    canvas.drawRect(frame.right - CORNER_RECT_WIDTH, frame.top, frame.right,
            frame.top + ScreenRate, paint);
    canvas.drawRect(frame.left, frame.bottom - CORNER_RECT_WIDTH, frame.left
            + ScreenRate, frame.bottom, paint);
    canvas.drawRect(frame.left, frame.bottom - ScreenRate, frame.left
            + CORNER_RECT_WIDTH, frame.bottom, paint);
    canvas.drawRect(frame.right - ScreenRate, frame.bottom
            - CORNER_RECT_WIDTH, frame.right, frame.bottom, paint);
    canvas.drawRect(frame.right - CORNER_RECT_WIDTH, frame.bottom
